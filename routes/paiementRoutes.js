...
router.post('/paiement.update.inhumation', checkAuth, paiementController.updateInh)
router.post('/paiement.update.incineration', checkAuth, paiementController.updateInc)
